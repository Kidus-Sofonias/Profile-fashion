    ...
    <div className="d-flex flex-column flex-md-row bg-light rounded-4 p-4 shadow-sm story-box">
      <div className="flex-fill p-3">
        ...
        <p>
          ...
          fashion. With Profile Fashion, you're not just in the moment, you ARE
          the moment. Get ready to step out, stand out, and seize the world
          alike. Embrace the thrill. Live the Profile Fashion Life. Fashion
          forward, always!
        </p>
        <button className="btn shop-now-btn mt-3">Shop Now →</button>
      </div>
